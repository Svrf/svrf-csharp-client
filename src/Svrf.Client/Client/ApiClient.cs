...
namespace Svrf.Client.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Svrf.Client.Client.Configuration.Default;
            RestClient = new RestClient("https://api.svrf.com/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.svrf.com/v1).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? Svrf.Client.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://api.svrf.com/v1")
        {
