...
namespace Svrf.Client.Model
{
    ...
    public partial class MediaVideos :  IEquatable<MediaVideos>, IValidatableObject
    {
        ...
        public MediaVideos(string _848 = default(string), string _1440 = default(string), string _2160 = default(string), string Clip = default(string), string Hls = default(string), string Max = default(string))
        {
            this._848 = _848;
            this._1440 = _1440;
            this._2160 = _2160;
