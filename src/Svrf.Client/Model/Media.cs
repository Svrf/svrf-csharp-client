...
namespace Svrf.Client.Model
{
    ...
    public partial class Media :  IEquatable<Media>, IValidatableObject
    {
        ...
        public Media(bool? Adult = false, List<string> Authors = default(List<string>), string Canonical = default(string), string Description = default(string), decimal? Duration = default(decimal?), MediaFiles Files = default(MediaFiles), int? Height = default(int?), string Id = default(string), string Site = default(string), string Title = default(string), TypeEnum? Type = default(TypeEnum?), string Url = default(string), int? Width = default(int?))
        {
