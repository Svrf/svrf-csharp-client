...
namespace SVRF.Client.Test
{
    ...
    public class MediaApiTests
    {
        ...
        public void GetTrendingTest()
        {
            ...
            //var response = instance.GetTrending(type, stereoscopicType, category, size, nextPageCursor);
        ...
        public void SearchTest()
        {
            ...
            //int? size = null;
            //int? pageNum = null;
            //var response = instance.Search(q, type, stereoscopicType, category, size, pageNum);
