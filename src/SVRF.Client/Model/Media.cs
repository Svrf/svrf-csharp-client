...
namespace SVRF.Client.Model
{
    ...
    public partial class Media :  IEquatable<Media>, IValidatableObject
    {
        ...
        /// <param name="Type">The type of the Media. This should influence the media controls displayed to the user..</param>
        ...
        public Media(bool? Adult = false, List<string> Authors = default(List<string>), string Canonical = default(string), string Description = default(string), decimal? Duration = default(decimal?), MediaFiles Files = default(MediaFiles), decimal? Height = default(decimal?), string Id = default(string), string Site = default(string), string Title = default(string), TypeEnum? Type = default(TypeEnum?), string Url = default(string), decimal? Width = default(decimal?))
        {
