...
namespace SVRF.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrendingResponse :  IEquatable<TrendingResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrendingResponse" /> class.
        /// </summary>
        /// <param name="Success">If the request was successful.</param>
        /// <param name="Media">Trending media.</param>
        /// <param name="NextPageCursor">Use in an additional request to get the next page of trending media. Valid for 30 minutes..</param>
        public TrendingResponse(bool? Success = default(bool?), List<Media> Media = default(List<Media>), string NextPageCursor = default(string))
        {
        ...
        /// </summary>
        /// <value>Use in an additional request to get the next page of trending media. Valid for 30 minutes.</value>
        ...
        {
            return this.Equals(input as TrendingResponse);
        }

        /// <summary>
        /// Returns true if TrendingResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrendingResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrendingResponse input)
        {
            if (input == null)
                return false;
