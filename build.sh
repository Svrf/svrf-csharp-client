...
${nuget_cmd} install src/SVRF.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/SVRF.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/SVRF.Client.dll \
-recurse:'src/SVRF.Client/*.cs' \
-doc:bin/SVRF.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/SVRF.Client.dll was created successfully"
fi
